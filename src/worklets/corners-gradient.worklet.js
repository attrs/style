// See https://css-houdini.rocks/corners-gradient
...
!(function (a) {
  ...
  function c(a) {
    ...
    return (
      ...
      'object' == typeof a && (J(a.r) && J(a.g) && J(a.b) ? ((b = d(a.r, a.g, a.b)), (j = !0), (k = '%' === String(a.r).substr(-1) ? 'prgb' : 'rgb')) : J(a.h) && J(a.s) && J(a.v) ? ((e = G(a.s)), (g = G(a.v)), (b = h(a.h, e, g)), (j = !0), (k = 'hsv')) : J(a.h) && J(a.s) && J(a.l) && ((e = G(a.s)), (i = G(a.l)), (b = f(a.h, e, i)), (j = !0), (k = 'hsl')), a.hasOwnProperty('a') && (c = a.a)),
      (c = z(c)),
  ...
  function L(a) {
    var b, c;
    return (a = a || { level: 'AA', size: 'small' }), (b = (a.level || 'AA').toUpperCase()), (c = (a.size || 'small').toLowerCase()), 'AA' !== b && 'AAA' !== b && (b = 'AA'), 'small' !== c && 'large' !== c && (c = 'small'), { level: b, size: c };
  }
  var M = /^\s+/,
    N = /\s+$/,
    O = 0,
  ...
  (b.prototype = {
    ...
    getLuminance: function () {
      var b,
        ...
        g,
        h = this.toRgb();
      return (b = h.r / 255), (c = h.g / 255), (d = h.b / 255), (e = 0.03928 >= b ? b / 12.92 : a.pow((b + 0.055) / 1.055, 2.4)), (f = 0.03928 >= c ? c / 12.92 : a.pow((c + 0.055) / 1.055, 2.4)), (g = 0.03928 >= d ? d / 12.92 : a.pow((d + 0.055) / 1.055, 2.4)), 0.2126 * e + 0.7152 * f + 0.0722 * g;
    },
    setAlpha: function (a) {
    ...
    toString: function (a) {
      ...
      return e
        ? 'name' === a && 0 === this._a
          ? this.toName()
          : this.toRgbString()
        : ('rgb' === a && (c = this.toRgbString()), 'prgb' === a && (c = this.toPercentageRgbString()), ('hex' === a || 'hex6' === a) && (c = this.toHexString()), 'hex3' === a && (c = this.toHexString(!0)), 'hex4' === a && (c = this.toHex8String(!0)), 'hex8' === a && (c = this.toHex8String()), 'name' === a && (c = this.toName()), 'hsl' === a && (c = this.toHslString()), 'hsv' === a && (c = this.toHsvString()), c || this.toHexString());
    },
    clone: function () {
    ...
    class {
      ...
      quadGradient(ctx, geom, corners) {
        ...
        for (var i = 0; i < h; i++) {
          ...
          startColor = this.arrayToRGBA(this.lerp(corners.topLeft, corners.bottomLeft, fac));
          endColor = this.arrayToRGBA(this.lerp(corners.topRight, corners.bottomRight, fac));

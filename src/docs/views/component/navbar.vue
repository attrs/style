  ...
  <div class="container p-pg mx-auto">
    <div class="pb-md border-b">
      <div class="flex items-center">
        ...
        <div class="flex-1">
          <h3>Navbar</h3>
          <p class="text-light font-light">Typography examples</p>
        </div>
      </div>
    </div>
    ...
    <div class="py-md">
      ...
      <!-- section gnb -->
      <div class="my-md border">
        <div class="x-navbar" flex="1">
          <div class="x-navbar">
            <div id="logo" class="text-xl font-thin px-5" style="width: 250px">
              <a class="tracking-widest">NAVBAR</a>
            </div>
            ...
            <div class="x-inputbox x-inputbox-rounded hidden">
              <svg class="icon" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="x-navbar">
            ...
            <div class="x-dropdown x-dropdown-align-right x-dropdown-nocaret">
              <a class="btn">
                ...
                <div class="x-badge x-badge-warning">99+</div>
              </a>
            ...
            <div class="x-dropdown x-dropdown-align-right">
              <a class="btn">
                <svg class="icon hidden" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="my-md">
        <!-- navbar -->
        <div class="x-navbar my-sm border">
          <div class="x-navbar">
            <a class="btn btn-icon">
              <svg class="icon" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <!-- // navbar -->
        <!-- navbar -->
        <div class="x-navbar x-navbar-align-start my-sm border">
          <a class="btn btn-icon">
            <svg class="icon" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              <path
                fill-rule="evenodd"
        ...
        <!-- // navbar -->
        <!-- navbar -->
        <div class="x-navbar x-navbar-align-center my-sm border">
          <a class="btn btn-icon">
            <svg class="icon" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              <path
                fill-rule="evenodd"
        ...
        <!-- // navbar -->
        <!-- navbar -->
        <div class="x-navbar x-navbar-align-end my-sm border">
          <a class="btn btn-icon">
            <svg class="icon" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              <path
                fill-rule="evenodd"
        ...
        <!-- // navbar -->
        <!-- navbar -->
        <div class="x-navbar x-navbar-align-around my-sm border">
          <a class="btn btn-icon">
            <svg class="icon" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              <path
                fill-rule="evenodd"
        ...
        <!-- // navbar -->
        <!-- navbar -->
        <div class="x-navbar x-navbar-align-between my-sm border">
          <a class="btn btn-icon">
            <svg class="icon" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              <path
                fill-rule="evenodd"
      ...
      <div class="my-auto flex justify-between">
        <!-- navbar -->
        <div class="x-navbar-v border">
          <div class="x-navbar-v">
            <a class="btn btn-icon">
              <svg class="icon" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path
                  fill-rule="evenodd"
        ...
        <!-- // navbar -->
        <!-- navbar -->
        <div class="x-navbar-v x-navbar-align-start border">
          <a class="btn btn-icon">
            <svg class="icon" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              <path
                fill-rule="evenodd"
        ...
        <!-- // navbar -->
        <!-- navbar -->
        <div class="x-navbar-v x-navbar-align-center border">
          <a class="btn btn-icon">
            <svg class="icon" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              <path
                fill-rule="evenodd"
        ...
        <!-- // navbar -->
        <!-- navbar -->
        <div class="x-navbar-v x-navbar-align-end border">
          <a class="btn btn-icon">
            <svg class="icon" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              <path
                fill-rule="evenodd"
        ...
        <!-- // navbar -->
        <!-- navbar -->
        <div class="x-navbar-v x-navbar-align-around border">
          <a class="btn btn-icon">
            <svg class="icon" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              <path
                fill-rule="evenodd"
        ...
        <!-- // navbar -->
        <!-- navbar -->
        <div class="x-navbar-v x-navbar-align-between border">
          <a class="btn btn-icon">
            <svg class="icon" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              <path
                fill-rule="evenodd"

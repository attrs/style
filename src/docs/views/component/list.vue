    ...
    <div class="p-md">
      <div class="grid grid-cols-3 gap-5">
        ...
        <div>
          <div class="x-card">
            <div class="x-list">
              <a class="x-list-item">List Item 1</a>
              <a class="x-list-item">List Item 2</a>
              <a class="x-list-item">List Item 3</a>
              <a class="x-list-item">List Item 4</a>
            </div>
          </div>
        </div>
        <!-- // card -->
        ...
        <div>
          <div class="x-card">
            <div class="x-list">
              ...
              <a class="x-list-item">
                List Item 4
                <span class="x-badge ml-5">100</span>
                <div class="tools">
                  <div class="x-caret"></div>
                </div>
              </a>
          ...
          <div class="x-card">
            <div class="x-list x-list-lined">
              ...
              <a class="x-list-item">
                ...
                List 3
                <div class="tools">
                  <span class="x-badge x-badge-danger">100</span>
                </div>
              </a>
              <a class="x-list-item">
                <svg class="icon" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="col-span-3">
          <!-- card -->
          <div class="x-card-title">Advanced</div>
          <div class="x-card">
            <div class="x-list x-list-lined x-list-hover">
              ...
              <div class="x-list-item">
                <div class="x-iconbox x-iconbox-circle x-iconbox-warning mr-5">
                  <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                    <path
                      fill-rule="evenodd"
                      d="M2.866 14.85c-.078.444.36.791.746.593l4.39-2.256 4.389 2.256c.386.198.824-.149.746-.592l-.83-4.73 3.523-3.356c.329-.314.158-.888-.283-.95l-4.898-.696L8.465.792a.513.513 0 0 0-.927 0L5.354 5.12l-4.898.696c-.441.062-.612.636-.283.95l3.523 3.356-.83 4.73zm4.905-2.767l-3.686 1.894.694-3.957a.565.565 0 0 0-.163-.505L1.71 6.745l4.052-.576a.525.525 0 0 0 .393-.288l1.847-3.658 1.846 3.658a.525.525 0 0 0 .393.288l4.052.575-2.906 2.77a.564.564 0 0 0-.163.506l.694 3.957-3.686-1.894a.503.503 0 0 0-.461 0z"
              ...
              <div class="x-list-item">
                ...
                <label class="x-switch x-switch-primary">
                  ...
                  <label for="distbystage" data-on="On" data-off="Off"></label>
                </label>
              </div>
              <div class="x-list-item">
